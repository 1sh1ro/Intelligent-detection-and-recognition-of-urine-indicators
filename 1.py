...
def detect_and_draw_color_blocks(image_path, output_path):
    # 读取图像
    ...
    # 输出色块的序号和颜色值
    #for i, (item, color) in enumerate(zip(item, color_blocks)):
        #print(f"{item}: {color}")
    #print(item_color_mapping)
...
# 使用示例
detect_and_draw_color_blocks('2.png', '1.png')
